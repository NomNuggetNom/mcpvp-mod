...
public class ConfigSmashSounds extends DummyModContainer {

	public static String soundStreakEnd;
	public static String soundStreak;
    
    public static String fileName = "mcpvp_smash_sounds.cfg";
    
    private static Configuration config;

    public ConfigSmashSounds() {
        config = null;
    ...
    public static void syncConfig() {
    	...
    	new SoundAlert("smash.kit", prop.getString(), Server.SMASH);
